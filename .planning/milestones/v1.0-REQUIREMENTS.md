...
- **ONBD-01**: Guided first-run tour with preloaded demo dataset
- **ONBD-02**: Contextual tooltips explaining each pipeline stage
- **ONBD-03**: Tour completion tracking (show once per user)
- **ONBD-04**: Tour replay from settings or help menu
- **ONBD-05**: Usage-triggered in-app nudges approaching limits
- **ONBD-06**: Soft locks — view results but gate exports when limit hit
- **ONBD-07**: Value reinforcement emails at key milestones
- **ONBD-08**: Interactive demo preview on landing page
- **ONBD-09**: Social proof section (testimonials, case study metrics)
- **ONBD-10**: Before vs after comparison (manual QC vs TruQC)
